...
VALUES (
        ...
        'Who did Megan meet? [MCQ: A) Heather | B) Max | C) Miss Bye | D) Happy]',
        'A',
        1
    ),
    (
        ...
        '[TF] Heather has a puppy named Max.',
        'true | T | t',
        2
    ),
    (
        ...
        'Where did Megan sit? [MCQ: A) At school | B) On bus | C) At home | D) Park]',
        'A',
        3
    ),
    (
    ...
    (
        ...
        'What did Megan say? [MCQ: A) I am tired | B) I made a new friend! | C) I lost my puppy | D) I am sad]',
        'B',
        5
    );
=======
...
>>>>>>> 5ab6d86470e9249873a8b1f1b4dfdecdd344007d
...
VALUES (
        ...
        'Who did Megan meet on the bus? [MCQ: A) Heather | B) Max | C) Mom | D) Miss Bye]',
        'A',
        1
    ),
    (
    ...
    (
        ...
        'Where did they sit together? [MCQ: A) Bus | B) School | C) Home | D) Park]',
        'B',
        3
    ),
    (
        ...
        '[TF] Megan did not have a good day.',
        'false | F | f',
        4
    ),
    (
        ...
        'What did Megan say at the end? [MCQ: A) I am lost | B) I made a new friend! | C) I am tired | D) I cried]',
        'B',
        5
    );
=======
...
VALUES (
        ...
        'Who did Megan meet on the bus? [MCQ: A) Heather | B) Teacher | C) Mom | D) Happy]',
        'A',
        1
    ),
    (
        ...
        'What is Heather’s puppy’s name? [MCQ: A) Max | B) Happy | C) Buddy | D) Spot]',
        'A',
        2
    ),
    (
        ...
        '[TF] Megan and Heather sat together.',
        'true | T | t',
        3
    ),
    (
        ...
        'Where did they eat? [MCQ: A) Bus | B) At lunch | C) Home | D) Playground]',
        'B',
        4
    ),
    (
        ...
        '[TF] Megan said her day was not good.',
        'false | F | f',
        5
    );
=======
...
VALUES (
        ...
        'Who did Megan meet on the bus? [MCQ: A) Heather | B) Miss Bye | C) Mom | D) Happy]',
        'A',
        1
    ),
    (
        ...
        '[TF] Megan and Heather both have puppies.',
        'true | T | t',
        2
    ),
    (
        ...
        'What is Megan’s puppy’s name? [MCQ: A) Max | B) Buddy | C) Happy | D) Spot]',
        'C',
        3
    ),
    (
        ...
        '[TF] Megan did not like her teacher.',
        'false | F | f',
        4
    ),
    (
        ...
        'What did Megan say? [MCQ: A) It was boring | B) It was scary | C) It was the best first day ever! | D) I am sad]',
        'C',
        5
    );
=======
...
VALUES (
        ...
        'Which detail shows Megan was nervous? [MCQ: A) Smiling | B) Butterflies in her stomach | C) Singing | D) Laughing]',
        'B',
        1
    ),
    (
        ...
        '[TF] Megan and Heather met for the first time at school.',
        'false | F | f',
        2
    ),
    (
        ...
        'What can you infer? [MCQ: A) They hate each other | B) They become friends quickly | C) They ignore each other | D) They fight]',
        'B',
        3
    ),
    (
        ...
        '[TF] Megan enjoyed her first day.',
        'true | T | t',
        4
    ),
    (
        ...
        'Which detail shows happiness? [MCQ: A) Crying | B) Running away | C) She smiled all the way | D) Sleeping]',
        'C',
        5
    );
=======
...
VALUES (
        'Grade 5 Quote & Inference Assessment',
        '5.RSLKID.1',
        '5.RSLKID.1.A',
        6,
        0.7
...
VALUES (
        ...
        'Which quote shows she was nervous and excited? [MCQ: A) Bus was loud | B) She held backpack tightly | C) She smiled | D) She felt both nervous and excited.]',
        'D',
        1
    ),
    (
        ...
        '[TF] Megan was worried she would not make friends.',
        'true | T | t',
        2
    ),
    (
        ...
        'What can you infer? [MCQ: A) She is shy | B) She is outgoing | C) She is mean | D) She is angry]',
        'B',
        3
    ),
    (
        ...
        '[TF] Megan did not enjoy her first day.',
        'false | F | f',
        4
    ),
    (
        ...
        'Which shows friendship? [MCQ: A) They fought | B) They ignored each other | C) They shared snacks and talked | D) They left early]',
        'C',
        5
    );
=======
