...
CREATE TABLE assignment_results (
    ...
    completed_at TIMESTAMP NOT NULL updated_at TIMESTAMP NOT NULL
);
...
ADD CONSTRAINT uq_standard_code UNIQUE (standard_code);

ALTER TABLE proficiencies
ADD CONSTRAINT uq_proficiency_code UNIQUE (proficiency_code);

ALTER TABLE modules
ADD CONSTRAINT uq_module_code UNIQUE (module_code);

ALTER TABLE assessments
ADD CONSTRAINT uq_assessment_code UNIQUE (item_code);